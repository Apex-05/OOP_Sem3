...
class Building {
    ...
    void setSquareFeets(int squareFeets) { this.squareFeets = squareFeets; }
    void setStories(int Stories) { this.Stories = Stories; }
    int getSquareFeets() { return this.squareFeets; }
    int getStories() { return this.Stories; }
}
...
class House extends Building {
    ...
    void setnoOfBedRomms(int noOfBedRomms) { this.noOfBedRomms = noOfBedRomms; }
    void setnoOfBathRooms(int noOfBathRooms) { this.noOfBathRooms = noOfBathRooms; }
    int getnoOfBedRomms() { return this.noOfBedRomms; }
    int getnoOfBathRooms() { return this.noOfBathRooms; }
}
...
class School extends Building {
    ...
    void setnoOfClassRooms(int noOfClassRooms) { this.noOfClassRooms = noOfClassRooms; }
    void setgradeLevel(String gradeLevel) { this.gradeLevel = gradeLevel; }
    int getnoOfClassRooms() { return this.noOfClassRooms; }
